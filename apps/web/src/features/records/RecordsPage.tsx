    ...
    return (
        <Container maxWidth="md" sx={{ py: 4 }}>
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5" fontWeight={600}>Записи</Typography>
                ...
                <Table size="small">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell sx={{ width: 140 }} align="right">Действия</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {rows.map((r) => (
                            <TableRow key={r.id} hover>
                                ...
                                <TableCell align="right">
                                    ...
                                    <IconButton color="error" size="small" onClick={() => onDelete(r.id)} aria-label="Удалить">
                ...
                <DialogContent>
                    <Stack spacing={2} sx={{ pt: 1 }}>
                        ...
                        <TextField
                            ...
                            onChange={(e) => edit && setEdit({ ...edit, data: { ...edit.data, content: e.target.value } })}
                            multiline
                            minRows={3}
                        />
                    </Stack>
